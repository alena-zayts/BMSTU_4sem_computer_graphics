...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(20, 200, 441, 231))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(20, 470, 441, 211))
        ...
        self.graph.setGeometry(QtCore.QRect(530, 30, 1600, 1350))
        self.graph.setObjectName("graph")
        self.table = QtWidgets.QTableWidget(self.centralwidget)
        self.table.setGeometry(QtCore.QRect(40, 850, 411, 371))
        font = QtGui.QFont()
        font.setPointSize(7)
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(20, 810, 441, 421))
        self.groupBox_4.setObjectName("groupBox_4")
        self.but_fill = QtWidgets.QPushButton(self.centralwidget)
        self.but_fill.setGeometry(QtCore.QRect(30, 1250, 321, 61))
        self.but_fill.setObjectName("but_fill")
        self.but_clean = QtWidgets.QPushButton(self.centralwidget)
        self.but_clean.setGeometry(QtCore.QRect(30, 1330, 321, 61))
        self.but_clean.setObjectName("but_clean")
        self.lbl_time = QtWidgets.QLabel(self.centralwidget)
        self.lbl_time.setGeometry(QtCore.QRect(560, 1290, 771, 41))
        self.lbl_time.setObjectName("lbl_time")
        self.but_connect = QtWidgets.QPushButton(self.centralwidget)
        self.but_connect.setGeometry(QtCore.QRect(20, 720, 441, 61))
        self.but_connect.setObjectName("but_connect")
        self.delay_lvl = QtWidgets.QSlider(self.centralwidget)
        self.delay_lvl.setGeometry(QtCore.QRect(30, 350, 411, 31))
        ...
        self.label.setGeometry(QtCore.QRect(30, 290, 351, 51))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.box_color.setItemText(1, _translate("MainWindow", "Розовый"))
        self.box_color.setItemText(2, _translate("MainWindow", "Бирюзовый"))
        self.box_color.setItemText(3, _translate("MainWindow", "Голубой"))
        self.box_color.setItemText(4, _translate("MainWindow", "Красный"))
        self.box_color.setItemText(5, _translate("MainWindow", "Синий"))
        self.box_color.setItemText(6, _translate("MainWindow", "Желтый"))
