...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.but_connect_cutter.setGeometry(QtCore.QRect(20, 950, 441, 61))
        ...
        self.but_connect_segment.setGeometry(QtCore.QRect(20, 1030, 441, 61))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Левая кнопка мыши - ввод вершины отсекаемого; правая - ввод вершины отсекателя. При вводе на холсте вершины отсекаемого, близкой к прямой, проходящей через ребро\n"
" отсекателя, будет введена точка, лежащая на этой прямой.  "))
