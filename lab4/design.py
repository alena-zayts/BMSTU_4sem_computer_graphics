...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.box_c_step.setMinimum(0.01)
        ...
        self.box_c_param.setGeometry(QtCore.QRect(290, 90, 301, 41))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(20, 770, 591, 491))
        self.groupBox_2.setObjectName("groupBox_2")
        self.box_e_xc = QtWidgets.QDoubleSpinBox(self.groupBox_2)
        self.box_e_xc.setGeometry(QtCore.QRect(100, 150, 131, 41))
        ...
        self.label_7.setGeometry(QtCore.QRect(10, 150, 47, 41))
        self.label_7.setObjectName("label_7")
        self.label_8 = QtWidgets.QLabel(self.groupBox_2)
        self.label_8.setGeometry(QtCore.QRect(10, 210, 47, 41))
        self.label_8.setObjectName("label_8")
        self.box_e_yc = QtWidgets.QDoubleSpinBox(self.groupBox_2)
        self.box_e_yc.setGeometry(QtCore.QRect(100, 210, 131, 41))
        ...
        self.but_ellipse.setGeometry(QtCore.QRect(30, 430, 191, 51))
        self.but_ellipse.setObjectName("but_ellipse")
        self.label_10 = QtWidgets.QLabel(self.groupBox_2)
        self.label_10.setGeometry(QtCore.QRect(10, 270, 91, 41))
        self.label_10.setObjectName("label_10")
        self.box_e_a = QtWidgets.QDoubleSpinBox(self.groupBox_2)
        self.box_e_a.setGeometry(QtCore.QRect(100, 270, 131, 41))
        self.box_e_a.setMinimum(0.01)
        ...
        self.but_ellipses.setGeometry(QtCore.QRect(300, 290, 191, 51))
        self.but_ellipses.setObjectName("but_ellipses")
        self.label_17 = QtWidgets.QLabel(self.groupBox_2)
        self.label_17.setGeometry(QtCore.QRect(10, 330, 91, 41))
        self.label_17.setObjectName("label_17")
        self.box_e_b = QtWidgets.QDoubleSpinBox(self.groupBox_2)
        self.box_e_b.setGeometry(QtCore.QRect(100, 330, 131, 41))
        self.box_e_b.setMinimum(0.01)
        ...
        self.box_e_param = QtWidgets.QComboBox(self.groupBox_2)
        self.box_e_param.setGeometry(QtCore.QRect(290, 80, 301, 41))
        self.box_e_param.setObjectName("box_e_param")
        self.box_e_param.addItem("")
        self.box_e_param.addItem("")
        self.label_15 = QtWidgets.QLabel(self.groupBox_2)
        self.label_15.setGeometry(QtCore.QRect(290, 40, 291, 41))
        self.label_15.setObjectName("label_15")
        self.label_16 = QtWidgets.QLabel(self.groupBox_2)
        self.label_16.setGeometry(QtCore.QRect(290, 210, 71, 41))
        self.label_16.setObjectName("label_16")
        self.box_e_step = QtWidgets.QDoubleSpinBox(self.groupBox_2)
        self.box_e_step.setGeometry(QtCore.QRect(360, 150, 131, 41))
        self.box_e_step.setMinimum(0.01)
        self.box_e_step.setMaximum(10000.0)
        self.box_e_step.setSingleStep(10.0)
        self.box_e_step.setProperty("value", 50.0)
        self.box_e_step.setObjectName("box_e_step")
        self.label_9 = QtWidgets.QLabel(self.groupBox_2)
        self.label_9.setGeometry(QtCore.QRect(290, 150, 71, 41))
        self.label_9.setObjectName("label_9")
        self.box_e_n = QtWidgets.QDoubleSpinBox(self.groupBox_2)
        self.box_e_n.setGeometry(QtCore.QRect(360, 210, 131, 41))
        self.box_e_n.setDecimals(0)
        self.box_e_n.setMinimum(1.0)
        self.box_e_n.setMaximum(10000.0)
        self.box_e_n.setSingleStep(10.0)
        self.box_e_n.setProperty("value", 10.0)
        self.box_e_n.setObjectName("box_e_n")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(_translate("MainWindow", "a(beg):"))
        self.but_ellipses.setText(_translate("MainWindow", "Спектр"))
        self.label_17.setText(_translate("MainWindow", "b(beg):"))
        self.box_e_param.setItemText(0, _translate("MainWindow", "a"))
        self.box_e_param.setItemText(1, _translate("MainWindow", "b"))
        self.label_15.setText(_translate("MainWindow", "Изменяемая полуось:"))
